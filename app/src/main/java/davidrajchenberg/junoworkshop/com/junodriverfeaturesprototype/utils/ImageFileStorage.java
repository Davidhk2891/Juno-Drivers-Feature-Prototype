...
public class ImageFileStorage {
    ...
    public static void createImageGallery(){
        ...
        String GALLERY_LOCATION = "Juno Prototype Features";
    ...
    static File createImageFile(String prefix) throws IOException {
    ...
    static Uri contentCamFile(Context ctx, File Image1){
